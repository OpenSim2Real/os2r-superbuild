# Install script for directory: /home/dawson/Documents/Repos/os2r-superbuild/src/gym-ignition/scenario/src/plugins/Physics
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so")
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so"
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins" TYPE SHARED_LIBRARY FILES "/home/dawson/Documents/Repos/os2r-superbuild/build/src/gym-ignition/lib/libPhysicsSystem.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/scenario/plugins/libPhysicsSystem.so")
    endif()
  endif()
endif()
