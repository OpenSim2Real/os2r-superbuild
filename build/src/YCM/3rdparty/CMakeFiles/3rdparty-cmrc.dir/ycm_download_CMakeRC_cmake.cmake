...
while(${_attempt} LESS ${_retries} AND NOT ${_succeeded})
  ...
  execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -P "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-cmrc.dir/ycm_download_CMakeRC_cmake_real.cmake"
  ...
  if(_res_var)
    ...
    if(NOT ${_attempt} EQUAL ${_retries})
      message(STATUS "Cannot download file https://raw.githubusercontent.com/vector-of-bool/cmrc/f26f6e35a859b0ba28818dbcc0ed9b3880881cf4/CMakeRC.cmake\n${_error_message}.\n  Retrying.\n")
    else()
      message(FATAL_ERROR "Cannot download file https://raw.githubusercontent.com/vector-of-bool/cmrc/f26f6e35a859b0ba28818dbcc0ed9b3880881cf4/CMakeRC.cmake\n${_error_message}")
    endif()
  else()
    set(_succeeded 1)
  endif()
endwhile()
execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -E copy_if_different "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-cmrc.dir/downloads/CMakeRC.cmake" "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/cmrc/CMakeRC.cmake")
