...
while(${_attempt} LESS ${_retries} AND NOT ${_succeeded})
  ...
  execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -P "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-vtk.dir/ycm_download_Copyright_txt_real.cmake"
  ...
  if(_res_var)
    ...
    if(NOT ${_attempt} EQUAL ${_retries})
      message(STATUS "Cannot download file https://gitlab.kitware.com/vtk/vtk/raw/v9.0.1/Copyright.txt\n${_error_message}.\n  Retrying.\n")
    else()
      message(FATAL_ERROR "Cannot download file https://gitlab.kitware.com/vtk/vtk/raw/v9.0.1/Copyright.txt\n${_error_message}")
    endif()
  else()
    set(_succeeded 1)
  endif()
endwhile()
execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -E copy_if_different "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-vtk.dir/downloads/Copyright.txt" "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/vtk/Copyright.txt")
