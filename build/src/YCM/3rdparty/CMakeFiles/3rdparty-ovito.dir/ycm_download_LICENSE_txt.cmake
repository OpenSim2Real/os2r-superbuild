...
while(${_attempt} LESS ${_retries} AND NOT ${_succeeded})
  ...
  execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -P "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-ovito.dir/ycm_download_LICENSE_txt_real.cmake"
  ...
  if(_res_var)
    ...
    if(NOT ${_attempt} EQUAL ${_retries})
      message(STATUS "Cannot download file https://gitlab.com/stuko/ovito/raw/8689fcb1fdd2e8dc748e76d54d3b77a3f87d384c/LICENSE.txt\n${_error_message}.\n  Retrying.\n")
    else()
      message(FATAL_ERROR "Cannot download file https://gitlab.com/stuko/ovito/raw/8689fcb1fdd2e8dc748e76d54d3b77a3f87d384c/LICENSE.txt\n${_error_message}")
    endif()
  else()
    set(_succeeded 1)
  endif()
endwhile()
execute_process(COMMAND "/home/dawson/.local/lib/python3.8/site-packages/cmake/data/bin/cmake" -E copy_if_different "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/CMakeFiles/3rdparty-ovito.dir/downloads/LICENSE.txt" "/home/dawson/Documents/Repos/os2r-superbuild/build/src/YCM/3rdparty/ovito/LICENSE.txt")
